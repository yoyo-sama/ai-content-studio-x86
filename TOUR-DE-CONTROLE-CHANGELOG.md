...
1. `create_comfy_stack` fait `mkdir -p "$COMFY_DIR/models"` quand elle s'exécute ;
...
Même correctif dans `scripts/lib-install-common.sh`, partagé par les deux installeurs.
